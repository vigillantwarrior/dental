    ...
    <section class="wrapper site-min-height">
        ...
        <section class="">
            <header class="panel-heading">
                <?php echo lang('medicine'). ' By Location'; ?> 
                        ...
                        <div class="btn-group pull-right">
                            <button id="" class="btn green btn-xs">
                             ...
                             <button id="" class="btn green btn-xs">
                                ...
                                <a href="medicine"><i class="fa fa-eye"></i> <?php echo 'All Medicines'; ?></a>
                            </button>
                              <button id="" class="btn green btn-xs">
                                
                                <a href="medicine/transferMedicineView"><i class="fa fa-plus-circle"></i> <?php echo 'Transfer'; ?></a>
                             </button>
                        </div>
                    </a>
                </div>
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        foreach ($medicines as $medicine) {
                            ...
                            <tr class="">
                                ...
                                <td> <?php
                                    if ($medicine->loc_quantity <= 0) {
                                        echo '<p class="os">Stock Out</p>';
                                    } else {
                                        echo $medicine->loc_quantity;
                                    }
                                    ?>
