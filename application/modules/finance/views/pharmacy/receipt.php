    ...
    <section class="wrapper site-min-height">
        ...
        <section>
            <div class="panel panel-primary">
                ...
                <div class="panel-body col-md-8 panel-moree" id="invoice" style="font-size: 10px;">
                    <div class="row invoice-list">
                        ...
                        <div class="col-lg-4 col-sm-4">
                            ...
                            <ul class="unstyled">
                                <li> <?php echo 'Receipt No'; ?> 		: <strong>00<?php echo $payment->id; ?></strong></li>
                                <!--
                ...
                <div class="col-md-5 panel-moree" style="font-size: 10px;">
                    ...
                    <div class="text-center invoice-btn clearfix">
                     ...
                     <div class="text-center invoice-btn clearfix">
                         <a href="finance/pharmacy/receipt?id=<?php echo $payment->id; ?>" class="btn btn-info btn-sm editbutton pull-left"><i class="fa fa-file"></i><?php echo lang('create'); ?> <?php echo 'Receipt'; ?> </a>
                    </div>
                    ...
                    <div class="text-center invoice-btn clearfix">
                        <?php if ($this->ion_auth->in_group(array('admin', 'Accountant'))) { ?>
                            <a href="finance/pharmacy/editPayment?id=<?php echo $payment->id; ?>&vol=<?php echo $payment->invoice_id;?>&tron=<?php echo $payment->patient;?>" class="btn btn-info btn-lg green pull-left"><i class="fa fa-edit"></i> <?php echo lang('edit_invoice'); ?> </a>
                        <?php } ?>
                    </div>
