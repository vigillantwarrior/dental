        ...
        <section class="col-md-4">
            <div class="col-md-5 no-print" style="margin-top: 20px;">
                ...
                <div class="text-center col-md-12 row">
                    ...
                    <a href="finance/receipt?id=<?php echo $payment->id; ?>" class="btn btn-info btn-sm editbutton pull-left"><i class="fa fa-edit"></i><?php echo lang('create'); ?> <?php echo 'receipt'; ?> </a>
