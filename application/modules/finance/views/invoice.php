                ...
                <div class="panel-body" style="font-size: 10px;">
                    <div class="row invoice-list">
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6 pull-left row" style="text-align: left;">
                                ...
                                <div class="col-md-12 row details" style="">
                                    <p>
                                        <label class="control-label"><?php echo 'Protocal No.'; ?>  </label>
                                        <span style="text-transform: uppercase;"> : 
                                            <?php
                                            if (!empty($patient_info)) {
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            if (!empty($payment->category_name)) {
                                ...
                                foreach ($category_name1 as $category_name2) {
                                    ...
                                    if ($category_name3[3] > 0) {
                                        ...
                                        <tr>
                                            <td><?php echo $i; ?> </td>
                                            <td><?php echo $this->finance_model->getPaymentcategoryById($category_name3[0])->description."(".$this->finance_model->getPaymentcategoryById($category_name3[0])->category.")"; ?> </td>
                            ...
                            if (!empty($pharmacy_payment->category_name)) {
                                ...
                                $category_name1 = explode(',', $category_name);
                                if (empty($pharmacy_payment->x_ray)) {
                                    $i = 0;
                                }
                                foreach ($category_name1 as $category_name2) {
                                    $category_name3 = explode('*', $category_name2);
                    ...
                    <div class="">
                        <div class="col-lg-4 invoice-block pull-right">
                            <ul class="unstyled amounts">
                                ...
                                echo $g = $payment->gross_total + $pharmacy_payment->gross_total; }
                                    else{ echo $g = $payment->gross_total;  }

                                 ?></li>
                                <li><strong><?php echo lang('amount_received'); ?> : </strong><?php echo $settings->currency; ?> 
                                
                                <?php if(!empty($pharmacy_payment->invoice_id) && $pharmacy_payment->status == 'paid'){

                                 echo $r = $this->finance_model->getDepositAmountByPaymentId($payment->id) + $pharmacy_payment->gross_total;}
                                 else{ echo $r = $this->finance_model->getDepositAmountByPaymentId($payment->id); }
                                 ?></li>
                    ...
                    <div class="col-md-12 invoice_footer">
                        <div class="col-md-4 row pull-left" style="">
                            <?php echo 'Served by'; ?> : <?php echo $this->ion_auth->user($payment->user)->row()->username; ?>
                            <div class="col-md-4 row pull-right" style="">
                            </div>
                        </div>
                        <p> <br> <br><br> <br>
                        Valid till: Invoice will be valid for one month from invoice date </p>
        ...
        <section class="col-md-4">
            <div class="col-md-5 no-print" style="margin-top: 20px;">
                ...
                <div class="text-center col-md-12 row">
                    ...
                    <a href="finance/receipt?id=<?php echo $payment->id; ?>" class="btn btn-info btn-sm editbutton pull-left"><i class="fa fa-file"></i><?php echo lang('create'); ?> <?php echo 'Receipt'; ?> </a>
