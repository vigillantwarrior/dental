        ...
        <section class="">
            <header class="panel-heading">
                ...
                ?>
                                               ...
                                               </br> <label for="exampleInputEmail1"><?php echo lang('patient'); ?></label>
                        ...
                        <form role="form" class="clearfix pos form1"  id="editPaymentForm" action="finance/pharmacy/addPayment" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group last">
                                        ...
                                        <div class="col-md-9 row">
                                            <select name="category_name[]" id="" class="multi-select" multiple="" id="my_multi_select3" >
                                                ...
                                                $quantity = $this->medicine_model->getMedicineQuantityByLocationByProductId($location_id =4 , $medicine->id);
                                                    if ($quantity->loc_quantity > 0) {
                                                        ?>
                                                        <option class="ooppttiioonn" data-id="<?php echo $medicine->id; ?>" data-s_price="<?php echo (float) $medicine->s_price; ?>" data-m_name = "<?php echo $medicine->name; ?>" data-c_name = "<?php echo $medicine->company; ?>" data-cs = "<?php echo $quantity->loc_quantity; ?>" value="<?php echo $medicine->id; ?>"
                                                        <?php
                            ...
                            <div class="col-md-4 right-six">
                                ...
                                <div class="col-md-12 payment right-six">
                                 ...
                                 <div class="col-md-12 payment right-six">
                                    <div class="col-md-3 payment_label"> 
                                        <label for="exampleInputEmail1"><?php echo "Payment Status"; ?></label>
                                    </div>
                                    <div class="col-md-9"> 
                                       <select class="form-control m-bot15" name="status">
                                            <option value="<?php if (!empty($payment->status)) {
