                                                ...
                                                <div class="form-group last"> 
                                                    ...
                                                    <select name="category_name[]" id="" class="multi-select" multiple="" id="my_multi_select3" >
                                                        <?php foreach ($categories as $category) { ?>
                                                            <option class="ooppttiioonn" data-id="<?php echo $category->c_price; ?>" data-idd="<?php echo $category->id; ?>" data-cat_name2="<?php echo $category->description; ?>" data-cat_name="<?php echo $category->category; ?>" value="<?php echo $category->category; ?>" 
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-12 payment right-six">
                                                ...
                                                <div class="col-md-12 payment right-six">
                                                    ...
                                                    <div class=""> 
                                                        <select class="form-control m-bot15 js-example-basic-single selecttype" id="selecttype" required="" name="is_new_patient" value=''> 
