                        ...
                        <tbody>
                            ...
                            foreach ($payment_categories as $category) {
                                ...
                                if (in_array($category->id, $category_id_for_reports)) {
                                    ?>
                                    <tr class="">
                                        <td><?php echo $category->category."-".$category->description; ?></td>
                                        <td>
                                                ...
                                                foreach ($category_names_and_amountss as $category_name_and_amountt) {
                                                    ...
                                                    if (($category->id == $category_namee[0])) {
                                                        $category_quantity = $category_namee[3];
                                                          ...
                                                          array_push($items, $category_name_and_amountt);
                                                          // var_dump($items);  
                                                    }
                                                }
                                            }
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if(!empty($doctors_commission)){
                                    $hospital_amount = $gross - $doctors_commission;

                                    echo number_format($hospital_amount);
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-8">
                                    <div class="degree">
                                        ...
                                        if (!empty($payments)) {
                                            if ($paid_number > 0) {
                                                $grosshospital = $hospital_amount;
                                                echo number_format($grosshospital);
                                            }
                                ...
                                <div class="col-xs-8">
                                    <div class="degree">
                                        ...
                                        <?php
                                         ...
                                         $doctorcom = $doctors_commission;

                                         echo number_format($doctorcom);
                                        ?>
                                    ...
                                    <div class="degree">
                                        ...
                                        if (!empty($deposits)) {
                                            ...
                                            if ($paid_number > 0) {
                                                ...
                                                echo number_format($deposited_amount);
                                            } else {
                                                echo '0';
                                            }
                                        } else {
                                ...
                                <div class="col-xs-8">
                                    <div class="degree">
                                        ...
                                        if (!empty($deposits)) {
                                            ...
                                            if ($paid_number > 0) {
                                                $deposited_amount = array_sum($deposited_amount);
                                                $gross_due = $gross_bill - $deposited_amount;

                                                echo number_format($gross_due);
                                            } else {
                                                echo '0';
                                            }
                                        } else {
                                ...
                                <div class="col-xs-8">
                                    <div class="degree">
                                        ...
                                        if (!empty($total_expense_by_category)) {
                                            $totalcatexpense = array_sum($total_expense_by_category);
                                            echo number_format($totalcatexpense);
