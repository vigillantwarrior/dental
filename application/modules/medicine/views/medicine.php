                    ...
                    <a data-toggle="modal" href="#myModal">
                        <div class="btn-group pull-right">
                            <button id="" class="btn green btn-xs">
                                ...
                                <a href="medicine/addMedicineView"><i class="fa fa-plus-circle"></i> <?php echo lang('add_medicine'); ?></a>
                            </button>
                             <button id="" class="btn green btn-xs">
                                
                                <a href="medicine/locationProducts"><i class="fa fa-eye"></i> <?php echo 'View Locations'; ?></a>
                            </button>
                        </div>
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        foreach ($medicines as $medicine) {
                            ...
                            <tr class="">
                               ...
                               $quantity = $this->medicine_model->getMedicineQuantityByProductId($medicine->id);
                                    if ($quantity->loc_quantity <= 0) {
                                        echo '<p class="os">Stock Out</p>';
                                    } else {
                                        echo $quantity->loc_quantity;
                                    }
                                    ?>
                                   ...
                                   <button type="button" class="btn btn-info btn-xs btn_width editbutton" data-toggle="modal" data-id="<?php echo $medicine->id; ?>"><i class="fa fa-edit"></i>  <?php echo lang('load'); ?></button> 
                                </td>
            ...
            <div class="modal-body row">
                <form role="form" action="medicine/addNewMedicine" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <input type="text" class="form-control" name="brand" id="exampleInputEmail1" value='' placeholder="">
                    </div>
            ...
            <div class="modal-body row">
                <form role="form" id="editMedicineForm" class="clearfix" action="medicine/addNewMedicine" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-12">
                     ...
                     <input type="hidden" class="form-control" name="id" id="id" value='' placeholder="">
                                    ...
                                    $(document).ready(function () {
                                        $(".editbutton").click(function (e) {
                                            ...
                                            $.ajax({
                                                ...
                                                // $('#editMedicineForm').find('[name="supplier"]').val(response.medicine.supplier).end()
                                                $('#editMedicineForm').find('[name="brand"]').val(response.medicine.brand).end()
