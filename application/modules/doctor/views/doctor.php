            ...
            <div class="modal-body row">
                <form role="form" action="doctor/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"><?php echo "Doctor ID"; ?></label>
                        <input type="text" class="form-control" name="did" required="" id="exampleInputEmail1" value='' placeholder="">
                    </div>
                    <div class="form-group col-md-6">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editDoctorForm" class="clearfix" action="doctor/addNew" method="post" enctype="multipart/form-data">
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"><?php echo "Doctor ID"; ?></label>
                        <input type="text" class="form-control" required="" readonly="" name="did" id="exampleInputEmail1" value='' placeholder="">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"><?php echo lang('name'); ?></label>
                        <input type="text" class="form-control" name="name" id="exampleInputEmail1" value='' placeholder="">
    ...
    $(document).ready(function () {
        $(".table").on("click", ".editbutton", function () {
            ...
            $.ajax({
                ...
                $('#editDoctorForm').find('[name="did"]').val(response.doctor.id).end()
    ...
    $(document).ready(function () {
        $(".table").on("click", ".inffo", function () {
            ...
            $.ajax({
                ...
                // Populate the form fields with the data returned from server
                $('#editDoctorForm').find('[name="id"]').val(response.doctor.id).end()
                $('.idClass').append(response.doctor.id).end()
