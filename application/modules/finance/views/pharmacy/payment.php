                            ...
                            <tr class="">
                                ...
                                <td> 
                                    <?php if ($this->ion_auth->in_group(array('admin', 'Pharmacist'))) { ?>
                                        <a class="btn btn-info btn-xs editbutton" href="finance/pharmacy/editPayment?id=<?php echo $payment->id; ?>&vol=<?php echo $payment->invoice_id;?>&tron=<?php echo $payment->patient;?>"><i class="fa fa-edit"> </i> <?php echo lang('edit'); ?></a>
                                    <?php } ?>
