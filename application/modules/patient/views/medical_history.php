            ...
            <aside class="profile-nav">
                <section class="">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li>  <?php echo "Occupation"; ?><span class="label pull-right r-activity"><?php echo $patient->occupation; ?></span></li>
                        <li>  <?php echo ('Residence'); ?><span class="label pull-right r-activity"><?php echo $patient->residence; ?></span></li>
                        <li>  <?php echo ('Member Type'); ?><span class="label pull-right r-activity"><?php echo $patient->member_type; ?></span></li>
                        <li>  <?php echo 'Heart Disease'; ?><span class="label pull-right r-activity"><?php echo $patient->heart_disease; ?></span></li>
                        <li>  <?php echo 'High Blood Pressure'; ?><span class="label pull-right r-activity"><?php echo $patient->hbp; ?></span></li>
                        <li>  <?php echo 'Low Blood Pressure'; ?><span class="label pull-right r-activity"><?php echo $patient->lbp; ?></span></li>
                        <li>  <?php echo 'Diabetes'; ?><span class="label pull-right r-activity"><?php echo $patient->diabetes; ?></span></li>
                        <li>  <?php echo 'Allergies'; ?><span class="label pull-right r-activity"><?php echo $patient->allergies; ?></span></li>
                        <li>  <?php echo 'Others'; ?><span class="label pull-right r-activity"><?php echo $patient->others; ?></span></li>
                    </ul>
                ...
                <header class="panel-heading tab-bg-dark-navy-blueee">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="">
                         ...
                         <li class="">
                            <a data-toggle="" href="finance/patientPaymentHistory?patient=<?php echo $patient->id;?>"><?php echo "Procedures and Payments"; ?></a>
                        </li>
                       <!--  <li class="">
            ...
            <div class="modal-body">
                <form role="form" action="appointment/addNew" class="clearfix row" method="post" enctype="multipart/form-data">
                 ...
                 <!--     <div class="col-md-6 panel">
                           ...
                           <label for="exampleInputEmail1"><?php echo '* VITALS'; ?></label><br>

                    </div> -->
                      
                        <div class="col-md-4 panel">
                        
                            <label for="exampleInputEmail1"><?php echo 'Height'; ?></label><input type="text" class="form-control" name="height" id="" value='<?php
                         ...
                         <div class="col-md-4 panel">
                            ...
                            <label for="exampleInputEmail1"><?php echo 'Weight'; ?></label><input type="text" class="form-control" name="weight" id="" value='<?php
                        ...
                        <div class="col-md-4 panel">
                            ...
                            <label for="exampleInputEmail1"><?php echo 'Temperature'; ?></label><input type="text" class="form-control" name="temperature" id="" value='<?php
                        ...
                        <div class="col-md-4 panel">
                            ...
                            <label for="exampleInputEmail1"><?php echo 'BP'; ?></label><input type="text" class="form-control" name="bp" id="" value='<?php
